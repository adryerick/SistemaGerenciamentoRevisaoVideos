...
export default function ProjectThumbnail({ project }: { project: Project }) {
  ...
  return <Link href={`/projetos/${project.id}`} aria-label={`Abrir vídeos do projeto ${project.name}`}
    className="group relative flex h-48 shrink-0 items-center justify-center overflow-hidden bg-gradient-to-br from-[#242b29] to-[#101413] focus-visible:outline-2 focus-visible:outline-white">
